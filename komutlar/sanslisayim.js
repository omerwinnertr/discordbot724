...
exports.run = (client, message, params) => {
  message.channel.send(':diamond_shape_with_a_dot_inside: **Senin Şanslı Sayın** :diamond_shape_with_a_dot_inside: (NOT : Şanslı Sayıların Senin Etkinliklerde Kazanma Şansını Arttırır :exclamation:)')
